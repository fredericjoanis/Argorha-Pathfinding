...
-----------------------------------------------------------------------------
*/
#ifndef __Path_AxisAlignedBox_H_
#define __Path_AxisAlignedBox_H_
        ...
        */
        ...
        public:
            ...
            */
            ...
            /** Returns whether or not this box intersects another.  This function is a modified
            * version of the AxisAlignedBox one. Note : This function should not be in this class ...
            *
            * @param[in] b the second box to check the intersection
            */

            inline bool intersectsNotEquals( const AxisAlignedBox& b) const
            {
                // Early-fail for nulls
                ...
                // Use up to 6 separating planes
                if (this->getMaximum().x <= b.getMinimum().x)
                    return false;
                if (this->getMaximum().y <= b.getMinimum().y)
                    return false;
                if (this->getMaximum().z <= b.getMinimum().z)
                    return false;

                if (this->getMinimum().x >= b.getMaximum().x)
                    return false;
                if (this->getMinimum().y >= b.getMaximum().y)
                    return false;
                if (this->getMinimum().z >= b.getMaximum().z)
                    return false;
